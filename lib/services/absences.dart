            ...
            get_absences(qi.text);
              ...
              loaded?Center(child: Container(
                ...
                child: Column(children: [
                  _absences_days!=0?Text("$_absences_days يوم ",style: TextStyle(fontSize: 20)):Text("ليس لديك غيابات لهذا الشهر",style: TextStyle(fontSize: 20)),
                  _absences_days!=0?Text("${formatCurrency.format(_absences_money)} دينار ",style: TextStyle(fontSize: 20)):SizedBox(),
